...
fixed the lie; this fixes the absence.
    ...
    python evals/run.py --agent account-ops            # needs ANTHROPIC_API_KEY
    python evals/run.py --agent account-ops --dry-run   # no model calls; checks the harness
...
def main() -> int:
    ...
    parser.add_argument("--agent", default="account-ops")
