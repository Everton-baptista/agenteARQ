...
fixed the lie; this fixes the absence.
    ...
    python evals/run.py --agent docs-assistant            # needs ANTHROPIC_API_KEY
    python evals/run.py --agent docs-assistant --dry-run   # no model calls; checks the harness
...
def main() -> int:
    ...
    parser.add_argument("--agent", default="docs-assistant")
