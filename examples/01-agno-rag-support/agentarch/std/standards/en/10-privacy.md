...
Purpose: personal data in an agent, independent of any jurisdiction.
...
**Intent.** Telemetry does not silently become a copy of every conversation.
**Severity** `blocker`
...
**Intent.** Something deletes, on a schedule someone chose.
...
**Intent.** Identifiers are removed before they reach storage.
**Severity** `major`
