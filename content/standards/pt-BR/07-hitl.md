---
lang: pt-BR
source: content/standards/en/07-hitl.md
source_sha256: "d6f74a22adc7635ee3654bc453886fe7a0b2420073516af9fca1715ecabf2ab1"
...
# 07. Humano no circuito

Propósito: quando uma pessoa decide, e o que ela precisa para decidir.
...
**Intenção.** Approval is decided by risk, not by intuition.
**Severidade** `blocker`
...
**Intenção.** The approver can actually judge.
**Severidade** `blocker`
...
**Intenção.** Silence is not consent.
**Severidade** `blocker`
