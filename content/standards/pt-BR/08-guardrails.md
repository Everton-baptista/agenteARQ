---
lang: pt-BR
source: content/standards/en/08-guardrails.md
source_sha256: "66ca1b86890983c0f0e15c0d708ac4bb8a0a123defc94361800918d47df07085"
...
Propósito: onde os checks são instalados, e o que acontece quando não conseguem decidir.
Versão: 0.1 · Status: draft · Escopo: `agent.yaml` `guardrails.{input,output,action}`.
...
**Intenção.** All three points are a decision, not an oversight.
**Severidade** `blocker`
...
**Intenção.** Untrusted input is inspected before it reaches the model.
...
**Intenção.** What the model produced is checked before anyone sees it.
**Severidade** `blocker` · **Fail mode** varies
...
**Intenção.** The last checkpoint before the world changes.
**Severidade** `blocker` · **Fail mode** `fail_closed`
...
**Intenção.** A gate that fails irreproducibly gets switched off.
**Severidade** `blocker`
