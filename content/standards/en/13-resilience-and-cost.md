# 13. Resilience and cost

Purpose: failing gracefully, and staying affordable while doing it.
...
**Intent.** A degraded dependency does not become a queue of retries.
**Severity** `major`
...
**Intent.** Partial service beats no service.
**Severity** `major`
