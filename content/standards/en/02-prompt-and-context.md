# 02. Prompt and context

Purpose: how instruction and data are kept apart, and why that boundary is structural.
...
**Intent.** A prompt change is a behaviour change, and it should be reviewable as one.
**Severity** `major`, `blocker` from content 1.1.0
...
**Intent.** Retrieved and received content is data.
...
**Intent.** Downstream code receives what it expects.
**Severity** `major`
