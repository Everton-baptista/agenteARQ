...
Purpose: what to emit, and what never to emit.
...
**Intent.** Telemetry another tool can read.
**Severity** `major`
...
**Intent.** Your dashboards keep meaning what they meant.
**Severity** `major`
...
**Intent.** The interesting events are the ones that did not happen.
**Severity** `major`
